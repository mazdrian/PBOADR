package duadimen;// duadimen.Trapesium.java
...
public class Trapesium extends DuaDimensi {
    ...
    public Double hitungLuas() {
        if (sisiAtas == null || sisiBawah == null || tinggi == null) {
            throw new IllegalStateException("Sisi atas, sisi bawah, dan tinggi harus diatur untuk menghitung luas duadimen.Trapesium.");
        }
    ...
    public Double hitungKeliling() {
        if (sisiAtas == null || sisiBawah == null || sisiMiring1 == null || sisiMiring2 == null) {
            throw new IllegalStateException("Keempat sisi harus diatur untuk menghitung keliling duadimen.Trapesium.");
        }
