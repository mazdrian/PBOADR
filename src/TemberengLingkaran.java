...
public class TemberengLingkaran extends DuaDimensi {
    ...
    public void setRadius(Double radiusLingkaran) {
        validatePositiveDimension(radiusLingkaran, "Radius Lingkaran");
    ...
    @Override
    public Double hitungLuas() { // Luas Tembereng Lingkaran
    ...
    @Override
    public Double hitungKeliling() { // Keliling Tembereng Lingkaran
        if (radiusLingkaran == null || sudutPusatRadian == null) {
