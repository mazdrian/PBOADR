...
public class TemberengBola extends Geometri {
    ...
    public void setRadius(Double radiusBola) {
        validatePositiveDimension(radiusBola, "Radius Bola");
    ...
    @Override
    public Double hitungLuas() { // Luas Permukaan Tembereng Bola
    ...
    @Override
    public Double hitungKelilingAtauVolume() { // Volume Tembereng Bola
        if (radiusBola == null || tinggiTembereng == null) {
