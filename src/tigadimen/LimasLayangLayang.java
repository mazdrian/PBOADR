...
import duadimen.LayangLayang;

/**
 * Represents a kite pyramid (Limas Layang-Layang), extending duadimen.LayangLayang.
 */
public class LimasLayangLayang extends LayangLayang { // Corrected class name
    ...
    public Double hitungVolumeLimas() { //
        ...
        // Reuse hitungLuas() from duadimen.LayangLayang for base area
