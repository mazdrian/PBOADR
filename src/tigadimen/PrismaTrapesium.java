package tigadimen;// tigadimen.PrismaTrapesium.java
...
public class PrismaTrapesium extends Geometri {
    ...
    public PrismaTrapesium() {
        super();
        this.nama = "Prisma duadimen.Trapesium";
    }
    ...
    // Volume Prisma duadimen.Trapesium
    @Override
    ...
    // Luas Permukaan Prisma duadimen.Trapesium
    @Override
