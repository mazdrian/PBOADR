...
import duadimen.Persegi;

/**
 * Represents a square pyramid (Limas duadimen.Persegi), extending duadimen.Persegi.
 */
public class LimasPersegi extends Persegi { // Corrected class name
    ...
    public LimasPersegi() {
        super();
        this.nama = "Limas duadimen.Persegi";
    }
    ...
    public LimasPersegi(Double sisi, Double tinggiLimas) { // Overloading constructor
        super(sisi); // Pass side to duadimen.Persegi constructor for base
    ...
    public Double hitungVolumeLimas() { //
        ...
        // Reuse hitungLuas() from duadimen.Persegi for base area
