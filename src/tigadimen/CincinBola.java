...
public class CincinBola extends Geometri {
    ...
    public CincinBola() {
        super();
        this.nama = "Cincin tigadimen.Bola";
    }
    ...
    @Override
    public Double hitungLuas() { // Luas Permukaan Cincin tigadimen.Bola (beda dgn cincin biasa)
    ...
    @Override
    public Double hitungKelilingAtauVolume() { // Volume Cincin tigadimen.Bola (beda dgn cincin biasa)
