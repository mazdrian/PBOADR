...
/**
 * Represents a spherical sector (Juring tigadimen.Bola), extending tigadimen.Bola.
 */
public class JuringBola extends Bola { // Corrected class name
    ...
    public JuringBola() {
        super();
        this.nama = "Juring tigadimen.Bola";
    }
    ...
    public void setTinggiKerucutBagianDalam(Double tinggiKerucutBagianDalam) {
        try {
            validatePositiveDimension(tinggiKerucutBagianDalam, "Tinggi tigadimen.Kerucut Bagian Dalam");
