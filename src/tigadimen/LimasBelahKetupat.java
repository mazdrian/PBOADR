...
import duadimen.BelahKetupat;

/**
 * Represents a rhombus pyramid (Limas Belah Ketupat), extending duadimen.BelahKetupat.
 */
public class LimasBelahKetupat extends BelahKetupat { // Corrected class name
    ...
    public LimasBelahKetupat(Double diagonal1, Double diagonal2, Double tinggiLimas) { // Overloading constructor
        super(diagonal1, diagonal2); // Pass diagonals to duadimen.BelahKetupat constructor for base area
    ...
    public Double hitungVolumeLimas() { //
        ...
        // Reuse hitungLuas() from duadimen.BelahKetupat for base area
    ...
    public Double hitungLuasPermukaanLimas() { //
        ...
        // Given that it's a "tigadimen.LimasBelahKetupat", typically it implies a right pyramid on a rhombus.
        ...
        // Given that it's a "tigadimen.LimasBelahKetupat", often people simplify and assume one effective slant height for lateral faces.
