...
/**
 * Represents a cone (tigadimen.Kerucut), extending duadimen.Lingkaran.
 */
public class Kerucut extends Lingkaran {
    ...
    public void setTinggiKerucut(Double tinggiKerucut) {
        try {
            validatePositiveDimension(tinggiKerucut, "Tinggi tigadimen.Kerucut");
