...
public class Segitiga extends DuaDimensi {
    ...
    public Double hitungLuas() {
        if (alas == null || tinggi == null) {
            throw new IllegalStateException("Alas dan tinggi harus diatur untuk menghitung luas Segitiga.");
        }
    ...
    public Double hitungKeliling() {
        if (sisi1 == null || sisi2 == null || sisi3 == null) {
            throw new IllegalStateException("Ketiga sisi harus diatur untuk menghitung keliling Segitiga.");
        }
