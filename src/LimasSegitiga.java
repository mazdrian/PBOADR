...
public class LimasSegitiga extends Geometri {
    ...
    public void setAlasSegitigaAlas(Double alasSegitigaAlas) {
        validatePositiveDimension(alasSegitigaAlas, "Alas Segitiga Alas");
        this.alasSegitigaAlas = alasSegitigaAlas;
    }

    public void setTinggiSegitigaAlas(Double tinggiSegitigaAlas) {
        validatePositiveDimension(tinggiSegitigaAlas, "Tinggi Segitiga Alas");
    ...
    // Luas Permukaan Limas Segitiga (assuming base is a general triangle, might need more info for specific side heights)
    @Override
