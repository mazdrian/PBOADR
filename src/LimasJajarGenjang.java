...
/**
 * Represents a parallelogram pyramid (Limas Jajar Genjang), extending JajarGenjang.
 */
public class LimasJajarGenjang extends JajarGenjang { // Corrected class name
    ...
    public LimasJajarGenjang(Double alas, Double tinggiBase, Double sisiMiringBase, Double tinggiLimas) { // Overloading constructor
        super(alas, tinggiBase); // Pass base dimensions to JajarGenjang
    ...
    public Double hitungVolumeLimas() { //
        ...
        // Reuse hitungLuas() from JajarGenjang for base area
     ...
     * Similar complexity to LimasBelahKetupat for lateral surface area.
